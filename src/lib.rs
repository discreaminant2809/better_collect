...
pub trait RefCollector: Sized {
    ...
    #[inline]
    fn chain<C: RefCollector<Item = Self::Item>>(self, other: C) -> Chain<Self, C> {
        assert_collector_by_ref(Chain::new(self, other))
    }

    #[inline]
    fn chain_owned<C: Collector<Item = Self::Item>>(self, other: C) -> Chain<Self, C> {
